...
!(function (e, t) {
  ...
  (e.ActionId = void 0),
    ...
    ((E = e.ConnectionStatus || (e.ConnectionStatus = {}))[(E.Connected = 1)] =
      "Connected"),
    (E[(E.Connecting = 2)] = "Connecting"),
    (E[(E.Disconnected = 3)] = "Disconnected"),
    (E[(E.Error = 4)] = "Error"),
      ...
      _render(e, t, i) {
        ...
        const r = (function (e, t) {
          const i = new URL(`${e || ""}`, location.href).href,
            ...
            n = Ee.find((e) => e.language === r) ?? { iso: "en", dir: "ltr" },
        ...
        const a =
          ...
          (this._options.time_scale
            ...
            : "");
        return [
          `<iframe\n\t\tversion="CL v30.0.0 (internal id a7798f5b2167d88489048eb7e1527e9bf896690e @ 2025-09-18T15:48:20.147Z)" id="${
            this._id
          }" name="${this._id}" src="${
            n.href
